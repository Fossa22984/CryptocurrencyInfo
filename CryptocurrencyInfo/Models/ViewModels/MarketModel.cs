namespace Models.ViewModels
{
    public class MarketModel : BaseModel
    {
        ...
        public string BaseId { get => _baseId; set => Set(ref _baseId, value); }
        public string QuoteId { get => _quoteId; set => Set(ref _quoteId, value); }
        public string BaseSymbol { get => _baseSymbol; set => Set(ref _baseSymbol, value); }
        public string QuoteSymbol { get => _quoteSymbol; set => Set(ref _quoteSymbol, value); }
        ...
        public string VolumePercent { get => _volumePercent; set => Set(ref _volumePercent, value); }
        public string Rank { get => _rank; set => Set(ref _rank, value); }
        public string PercentTotalVolume { get => _percentTotalVolume; set => Set(ref _percentTotalVolume, value); }
        public string VolumeUsd { get => _volumeUsd; set => Set(ref _volumeUsd, value); }
        public string TradingPairs { get => _tradingPairs; set => Set(ref _tradingPairs, value); }
        public string ExchangeUrl { get => _exchangeUrl; set => Set(ref _exchangeUrl, value); }
    }
}
